 ...
 * {@link Division.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Division#newInstance} factory method to
...
public class Division extends Fragment {
     ...
     * @return A new instance of fragment Division.
     */
    // TODO: Rename and change types and number of parameters
    public static Division newInstance(String param1, String param2) {
        Division fragment = new Division();
...
//        divisionList.addAll(Arrays.asList(division));

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getContext(), android.R.layout.simple_list_item_1, division);
